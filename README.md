...
- **导出 PDF / 下载 HTML / + 区块 / 清空内容**。

**加内容不用写 HTML。** 鼠标移到任何一条经历、一个要点、一个区块标题上，左边会浮出一个小面板：
...
改动自动存在本机浏览器里，换设备不同步，要留档点「下载 HTML」，存下来的还是一个能独立打开的单文件。
...
| `app/index.html` | 在线版单文件：空白模板 + 缩放滑块 + 锁定一页 + 结构编辑 |
